...
export function InviteMemberDialog({
  ...
  async function handleCreate() {
    ...
    try {
      ...
      setResult({
        ...
        accountName: account?.name ?? 'Sri Lakshmi Industries',
      });
      onCreated();
    } catch (err) {
  ...
  function whatsappShareUrl(url: string): string {
    ...
    // they're being invited to before clicking through.
    const accountName = result?.accountName ?? 'Sri Lakshmi Industries';
